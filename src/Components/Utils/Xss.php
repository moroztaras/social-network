    ...
    protected static function attributes($attributes)
    {
        ...
        case 0:
          ...
          if (preg_match('/^([-a-zA-Z][-a-zA-Z0-9]*)/', $attributes, $match)) {
              ...
              $skip = ('style' == $attribute_name || 'on' == substr($attribute_name, 0, 2));
              ...
              $skip_protocol_filtering = 'data-' === substr($attribute_name, 0, 5) || in_array($attribute_name, [
                'title',
                'alt',
                'rel',
                'property',
